...
class Game {
  ...
  drawCanvas() {
    ...
    this.ctx.fillStyle = "rgba(60,120,180,0.2)";
    // this.ctx.fillRect(0, 0, this.gameCanvas.width, this.gameCanvas.height);
    this.spriteImage.onload = () => {
      // 398,628,
      this.ctx.drawImage(this.spriteImage, 398, 0, 230, 627, 0, 0, 230, 627);
      this.ctx.drawImage(this.spriteImage, 398, 0, 230, 627, 230, 0, 230, 627);
      this.ctx.drawImage(this.spriteImage, 398, 0, 230, 627, 460, 0, 230, 627);
    };
